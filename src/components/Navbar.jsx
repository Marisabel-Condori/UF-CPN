    ...
    <Router>
      <div className="container mt-5">
        ...
        <span className="navbar-brand mb-0 h1">FCPN</span>
          ...
          {isAuthenticated?
          <NavLink to="/Logout" className="btn btn-dark float-right mt-1 ml-2"> Cerrar sesion </NavLink> 
          :<NavLink to="/Login" className="btn btn-dark float-right mt-1 ml-2"> Iniciar sesion </NavLink>
          }
